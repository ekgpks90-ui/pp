...
export const workItems = [
  ...
  { id: 'wi-9', title: '스카이벤처스 UX 리서치', description: '스카이벤처스 신규 서비스 출시 전 사용자 인터뷰 분석 및 페르소나 도출.', start: '2026-06-10', end: '2026-06-20', type: '일반', participants: ['Jihye', '김도현', '최유진', '장준혁'], sourceRequestId: 'wr-r4', processId: 'pc-1',
    ...
    stepDeadlines: { 'ps-1-05': '2026-06-16', 'ps-1-08': '2026-06-18', 'ps-1-12': '2026-06-20' } },
  ...
  { id: 'wi-16', title: '넥스트에듀 서비스 소개 영상', description: '넥스트에듀(주) 온라인 교육 플랫폼 서비스 소개 영상 60초. 스토리보드부터 최종 편집까지.', start: '2026-06-15', end: '2026-06-25', type: '일반', participants: ['Jihye', '박서연', '정하은', '장준혁'], sourceRequestId: 'wr-r10', processId: 'pc-4',
    ...
    stepDeadlines: { 'ps-4-03': '2026-06-19', 'ps-4-07': '2026-06-23', 'ps-4-09': '2026-06-25' } },
...
export const sessions = [
  ...
  { id: 'ws-1', workItemId: 'wi-9', stepId: 'ps-1-12', authorId: 'u-1', authorName: 'Jihye', date: TODAY_ISO, category: '기획', title: '최종 디자인 확정', startTime: '', endTime: '', done: false },
  { id: 'ws-2', workItemId: 'wi-5', stepId: 'ps-1-12', authorId: 'u-1', authorName: 'Jihye', date: TODAY_ISO, category: '기획', title: '최종 디자인 확정', startTime: '', endTime: '', done: false },
  { id: 'ws-3', workItemId: 'wi-16', stepId: 'ps-4-03', authorId: 'u-1', authorName: 'Jihye', date: TODAY_ISO, category: '기획', title: '1차 피드백', startTime: '', endTime: '', done: false },
  { id: 'ws-4', workItemId: 'wi-15', stepId: 'ps-1-05', authorId: 'u-1', authorName: 'Jihye', date: TODAY_ISO, category: '기획', title: '1차 피드백', startTime: '', endTime: '', done: false },
  ...
  { id: 'ws-t22', workItemId: 'wi-7', stepId: 'ps-1-12', authorId: 'u-1', authorName: 'Jihye', date: TODAY_ISO, category: '기획', title: '최종 디자인 확정', startTime: '', endTime: '', done: false },
  // wi-7 가상 작업세션 — 여러 날짜에 걸친 단계별 진행(캘린더 단계 막대 시연용)
  { id: 'ws-v01', workItemId: 'wi-7', stepId: 'ps-1-01', authorId: 'u-1', authorName: 'Jihye', date: '2026-06-09', category: '기획', title: '브리핑 & 계약', startTime: '10:00', endTime: '12:00', done: true },
  { id: 'ws-v02', workItemId: 'wi-7', stepId: 'ps-1-02', authorId: 'u-5', authorName: '최유진', date: '2026-06-10', category: '리서치', title: '사용자·경쟁사 리서치', startTime: '10:00', endTime: '13:00', done: true },
  { id: 'ws-v03', workItemId: 'wi-7', stepId: 'ps-1-02', authorId: 'u-5', authorName: '최유진', date: '2026-06-11', category: '리서치', title: '리서치 결과 정리', startTime: '10:00', endTime: '12:00', done: true },
  { id: 'ws-v04', workItemId: 'wi-7', stepId: 'ps-1-02', authorId: 'u-4', authorName: '김도현', date: '2026-06-10', category: '리서치', title: '경쟁사 벤치마킹', startTime: '14:00', endTime: '17:00', done: true },
  { id: 'ws-v05', workItemId: 'wi-7', stepId: 'ps-1-02', authorId: 'u-4', authorName: '김도현', date: '2026-06-11', category: '리서치', title: '리서치 보고서 작성', startTime: '10:00', endTime: '12:00', done: true },
  { id: 'ws-v06', workItemId: 'wi-7', stepId: 'ps-1-03', authorId: 'u-5', authorName: '최유진', date: '2026-06-12', category: '기획', title: '정보구조(IA) 초안', startTime: '10:00', endTime: '13:00', done: true },
  { id: 'ws-v07', workItemId: 'wi-7', stepId: 'ps-1-03', authorId: 'u-5', authorName: '최유진', date: '2026-06-13', category: '기획', title: 'IA 확정', startTime: '10:00', endTime: '12:00', done: true },
  { id: 'ws-v08', workItemId: 'wi-7', stepId: 'ps-1-04', authorId: 'u-5', authorName: '최유진', date: '2026-06-13', category: '기획', title: '와이어프레임 1차', startTime: '14:00', endTime: '18:00', done: true },
  { id: 'ws-v09', workItemId: 'wi-7', stepId: 'ps-1-04', authorId: 'u-5', authorName: '최유진', date: '2026-06-14', category: '기획', title: '와이어프레임 보완', startTime: '10:00', endTime: '13:00', done: true },
  { id: 'ws-v10', workItemId: 'wi-7', stepId: 'ps-1-06', authorId: 'u-5', authorName: '최유진', date: '2026-06-15', category: '디자인', title: '1차 UI 디자인', startTime: '10:00', endTime: '18:00', done: true },
  { id: 'ws-v11', workItemId: 'wi-7', stepId: 'ps-1-06', authorId: 'u-5', authorName: '최유진', date: '2026-06-16', category: '디자인', title: '1차 UI 디자인 (이어서)', startTime: '10:00', endTime: '17:00', done: true },
  { id: 'ws-v12', workItemId: 'wi-7', stepId: 'ps-1-08', authorId: 'u-5', authorName: '최유진', date: '2026-06-17', category: '디자인', title: '2차 UI 디자인', startTime: '10:00', endTime: '18:00', done: false },
  { id: 'ws-v13', workItemId: 'wi-7', stepId: 'ps-1-08', authorId: 'u-5', authorName: '최유진', date: '2026-06-18', category: '디자인', title: '2차 UI 디자인 (이어서)', startTime: '10:00', endTime: '16:00', done: false },
  { id: 'ws-v14', workItemId: 'wi-7', stepId: 'ps-1-12', authorId: 'u-7', authorName: '장준혁', date: '2026-06-19', category: '디자인', title: '최종 디자인 검토', startTime: '14:00', endTime: '16:00', done: false },
  { id: 'ws-v15', workItemId: 'wi-7', stepId: 'ps-1-12', authorId: 'u-7', authorName: '장준혁', date: '2026-06-20', category: '디자인', title: '최종 확정', startTime: '10:00', endTime: '12:00', done: false },
  { id: 'ws-t46', workItemId: 'wi-10', stepId: 'ps-2-10', authorId: 'u-1', authorName: 'Jihye', date: TODAY_ISO, category: '기획', title: '최종 디자인 확정', startTime: '', endTime: '', done: false },
  { id: 'ws-t58', workItemId: 'wi-11', stepId: 'ps-1-08', authorId: 'u-1', authorName: 'Jihye', date: TODAY_ISO, category: '기획', title: '2차 피드백', startTime: '', endTime: '', done: false },
  { id: 'ws-t59', workItemId: 'wi-11', stepId: 'ps-1-12', authorId: 'u-1', authorName: 'Jihye', date: TODAY_ISO, category: '디자인', title: '최종 디자인 확정', startTime: '', endTime: '', done: false },
  { id: 'ws-t68', workItemId: 'wi-12', stepId: 'ps-3-05', authorId: 'u-1', authorName: 'Jihye', date: TODAY_ISO, category: '기획', title: '1차 피드백', startTime: '', endTime: '', done: false },
  { id: 'ws-t103', workItemId: 'wi-17', stepId: 'ps-2-08', authorId: 'u-1', authorName: 'Jihye', date: TODAY_ISO, category: '기획', title: '2차 피드백', startTime: '', endTime: '', done: false },
];
...
export const requests = [
  { id: 'wr-1', title: '신제품 론칭 SNS 배너', detail: '7월 신제품 론칭에 맞춰 인스타그램·페이스북용 배너 각 2종씩 제작 요청드립니다.', requester: '김지수', start: '2026-06-18', end: '2026-06-23', priority: '긴급', status: '수락 대기',
    processId: 'pc-3',
    selectedSteps: [
      { stepId: 'ps-3-02', title: '콘셉트 기획', role: '기획', deadline: '2026-06-20' },
      { stepId: 'ps-3-04', title: '시안 제작', role: '디자인', deadline: '2026-06-23' },
    ],
    stepAssignees: { 'ps-3-02': ['Jihye'], 'ps-3-04': ['Jihye', '최유진'] } },
  { id: 'wr-2', title: '채용 공고 포스터 디자인', detail: 'UI 디자이너 채용 공고 포스터 제작 부탁드립니다.', requester: '박소현', start: '2026-06-18', end: '2026-06-24', priority: '일반', status: '수락 대기',
    processId: 'pc-2',
    selectedSteps: [
      { stepId: 'ps-2-04', title: '시안 제작', role: '디자인', deadline: '2026-06-22' },
      { stepId: 'ps-2-10', title: '최종 디자인 확정', role: '디자인', deadline: '2026-06-24' },
    ],
    stepAssignees: { 'ps-2-04': ['Jihye'], 'ps-2-10': ['Jihye'] } },
  { id: 'wr-3', title: '신규 서비스 인트로 모션', detail: '앱 첫 진입 시 재생되는 15초 인트로 모션 그래픽이 필요합니다.', requester: '이준호', start: '2026-06-19', end: '2026-06-27', priority: '일반', status: '수락 대기',
    processId: 'pc-4',
    selectedSteps: [
      { stepId: 'ps-4-02', title: '스토리보드 작성', role: '기획', deadline: '2026-06-25' },
    ],
    stepAssignees: { 'ps-4-02': ['Jihye'] } },
];
...
export const assignmentRequests = [
  ...
  { id: 'ar-4', title: '서비스 소개 브로셔 리디자인', team: '기획팀', hours: 8, deadline: '2026-06-25', priority: '일반', status: '재배정', assignees: ['이나경', '정하은'], processId: 'pc-2', stepAssignees: { 'ps-2-01': ['Jihye'], 'ps-2-02': ['이나경'], 'ps-2-03': ['이나경'], 'ps-2-05': ['Jihye', '이나경'], 'ps-2-06': ['이나경'], 'ps-2-07': ['이나경', '정하은'], 'ps-2-08': ['Jihye', '이나경', '정하은'], 'ps-2-09': ['이나경'], 'ps-2-11': ['이나경'], 'ps-2-12': ['정하은'] }, rejectedStepAssignees: { 'ps-2-04': ['Jihye'], 'ps-2-10': ['이나경', '정하은'] } },
